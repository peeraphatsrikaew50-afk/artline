...
class ApiService {
  constructor() {
    // 📍 Web App URL ใหม่ล่าสุด (New Deployment)
    this.apiUrl = "https://script.google.com/macros/s/AKfycbxrYtqMWPy0OZoOJkB9iDtvEmT81kyomOgXDmo09fbXKeRBuYRJ3O59L1gNDzonnVGO/exec";
  }
